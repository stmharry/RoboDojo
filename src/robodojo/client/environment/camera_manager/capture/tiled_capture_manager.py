...
from robodojo.client.environment.camera_manager.capture.camera_view import CameraView
from robodojo.client.environment.camera_manager.frame_projection import FrameProjectionPipeline
    ...
    def init_cameras(self):
        ...
        for cam_id, camera_name in enumerate(self.camera_names[0]):
            ...
            for annotator_name in self.annotator_type[cam_id]:
                from robodojo.client.environment.camera_manager.capture.camera_view import ANNOTATOR_SPEC

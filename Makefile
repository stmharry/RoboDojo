...
$(eval $(call register_preset,molmoact2-bimanual_yam-default-deposit_coin,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,deposit_coin))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-fasten_screws,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,fasten_screws))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-fold_clothes,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,fold_clothes))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-general_pickup,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,general_pickup))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-insert_key,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,insert_key))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-play_Xylophone,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,play_Xylophone))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-plug_in_charger,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,plug_in_charger))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-push_T,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,push_T))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-push_T_random,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,push_T_random))
$(eval $(call register_preset,molmoact2-bimanual_yam-default-swap_T,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,default,swap_T))
$(eval $(call register_preset,molmoact2-bimanual_yam-molmo_yam-fold_clothes,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,molmo_yam,fold_clothes))
$(eval $(call register_preset,molmoact2-bimanual_yam-molmo_yam-general_pickup,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,molmo_yam,general_pickup))
$(eval $(call register_preset,molmoact2-bimanual_yam-moonlake_office-pack_item_into_container,XPolicyLab/policy/MolmoACT2,molmoact2,molmoact2_bimanual_yam,bimanual_yam,moonlake_office,pack_item_into_container))
...
$(eval $(call register_preset,pi05-bimanual_yam-molmo_yam-general_pickup,XPolicyLab/policy/Pi_05,uv,pi05_yam_molmoact2,bimanual_yam,molmo_yam,general_pickup))
$(eval $(call register_preset,pi05-bimanual_yam-moonlake_office-general_pickup,XPolicyLab/policy/Pi_05,uv,pi05_yam_molmoact2,bimanual_yam,moonlake_office,general_pickup))
$(eval $(call register_preset,pi05-bimanual_yam-moonlake_office-pack_item_into_container,XPolicyLab/policy/Pi_05,uv,pi05_yam_molmoact2,bimanual_yam,moonlake_office,pack_item_into_container))
$(eval $(call register_preset,pi05-bimanual_yam-moonlake_office-stack_blocks,XPolicyLab/policy/Pi_05,uv,pi05_yam_molmoact2,bimanual_yam,moonlake_office,stack_blocks))
$(eval $(call register_preset,pi05-bimanual_yam-moonlake_office-stack_bowls,XPolicyLab/policy/Pi_05,uv,pi05_yam_molmoact2,bimanual_yam,moonlake_office,stack_bowls))

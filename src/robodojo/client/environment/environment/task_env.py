...
from robodojo.client.environment.camera_manager.camera_manager import CameraManager
from robodojo.client.environment.camera_manager.mount_registry import CameraMountRegistry
from robodojo.client.environment.camera_manager.rig_spec import normalize_camera_rig
from robodojo.client.environment.environment.base_env import BaseEnv
from robodojo.client.environment.robot_manager.control_manager import ControlSeq
from robodojo.client.environment.robot_manager.robot_manager import RobotManager
from robodojo.client.environment.scene_manager.scene_manager import SceneManager
...
class TaskEnv(BaseEnv):
    def __init__(self, config, app, **kwargs):
        ...
        from robodojo.client.environment.camera_manager.capture.tiled_capture_manager import TiledCaptureManager

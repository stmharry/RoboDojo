...
from robodojo.client.environment.global_configs import BENCHMARK, ROOT_DIR
...
from robodojo.client.environment.global_configs import ENV_CONFIG_PATH
from robodojo.client.evaluation.eval_env import create_eval_env
from robodojo.client.utils.cluttered_generator import UnStableError
from robodojo.client.utils.load_file import load_yaml
from robodojo.client.utils.pipeline_utils import process_config, process_randomization, resolve_random_task_num_envs
...
def main():
    ...
    while env.env_seeds is not None:
        ...
        try:
            ...
            if export_pending:
                from robodojo.client.scene_export.exporter import export_scene_snapshot
